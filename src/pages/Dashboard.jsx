...
const Dashboard = () => {
  ...
  const stats = [
...

    {
      ...
      subtitle: "Converted solar clients",
      color: "#16a34a",
    },
    ...
    {
      title: "Open Services",
      value: dashboardData.stats.openServices,
      subtitle: "Complaints & maintenance",
      color: "#0891b2",
    },

    {
      title: "Today Follow-ups",
      value: dashboardData.stats.todayFollowups,
      subtitle: "Sales calls pending",
      color: "#0f766e",
    },
  ];
  ...
  const activities = dashboardData.tasks || [];
